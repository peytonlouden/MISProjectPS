...
<body>
    <form id="form1" runat="server">
        <div <%--id="Content" style="margin:0 auto; text-align:center" align="center"--%>>
            ...
            <br />
            <br />
            <asp:Label ID="lblConfirmPassword" runat="server" Font-Names="Corbel" Text="Confirm Password"></asp:Label>
            ...
            <br />
            <br />
            <asp:Button ID="btnLogin" runat="server" Font-Names="Corbel" Text="Login" />
